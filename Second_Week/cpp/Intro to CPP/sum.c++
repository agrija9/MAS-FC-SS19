...
int main()
{
    ...
    */
    ...
    div = (float)num1 / (float)num2; //cast operands into floats
    ...
    */
    ...
    cout << username  << ", the difference of " << num1 << " and " << num2 << " is: " << diff << endl;
    cout << username  << ", the product of " << num1 << " and " << num2 << " is: " << prod << endl;
    cout << username  << ", the division of " << num1 << " and " << num2 << " is: " << div << endl;
